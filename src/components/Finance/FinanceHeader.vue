        ...
        <form @submit.prevent="handleSubmit(onSubmit())" class="m-head-container-card">
            ...
            <div class="m-container-item--row vertical-center">
                ...
                <ValidationProvider class="relative" v-slot="{ errors }" rules="category">
                    <div name="categorias"
                                        class="m-container-item--column icons-container--toggle item--unset-flex"
                                        :class="toogleClass">
                        <div class="m-container-item--col-row space-around" v-for="(iconSections, i) in getIconData" :key="i">
                            <div class="m-container-item--column simple-column" v-for="(icon, index) in iconSections" :key="index">
